...
Public Class Staff_bidang
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim query = "SELECT idlaporan as 'ID Laporan', nama AS 'Nama Pelapor', nohp AS 'No HP Pelapor', namabidang AS 'Bidang', Tanggal, laporan FROM laporan_keluhan INNER JOIN bidang ON laporan_keluhan.idbidang = bidang.idbidang INNER JOIN akun ON laporan_keluhan.idakun_pelapor = akun.idakun INNER JOIN staff_bidang ON akun.idakun = staff_bidang.idakun"
